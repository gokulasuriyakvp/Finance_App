...
class OptimizedSavingFormScreen extends StatefulWidget {
  const OptimizedSavingFormScreen({super.key});

  @override
  State<OptimizedSavingFormScreen> createState() => _OptimizedSavingFormScreenState();
}

class _OptimizedSavingFormScreenState extends State<OptimizedSavingFormScreen> {
  ...
  Widget build(BuildContext context) {
    if (firstTimeFlag == false) {
      ...
      final savingDetail = ModalRoute.of(context)!.settings.arguments;
      if (savingDetail == null) {
        print('------------>FAB: Insert/Add:');
      } else {
        print('----------->ListView: Received:Edit/Delete');
        savingDetail as SavingModel;
        ...
        if (savingDetail.Category == 'Fixed') {
  ...
  void _add() async {
    ...
    final result =
    await dbHelperSaving.insertsavingDetails(row, SavingDatabaseHelper.savingDetialsTable);
